...
window.onload = function() {
	...
	$("#correlAllButton").on('click', function() {
		...
		// Loading logo
		$('.modalImage').attr('src', "../../images/myapp/loader.gif");
		setTimeout(function(){ $('.modalImage').attr('src', "../../images/myapp/LDA1.png"); }, 2000);
	...
	$("#correlAgeButton").on('click', function() {
		...
		// Loading logo
		$('.modalImage').attr('src', "../../images/myapp/loader.gif");
		setTimeout(function(){ $('.modalImage').attr('src', "../../images/myapp/LDA2.png"); }, 2000);
		location.href = '#openModal';  // Open modal window for LDA
	});
